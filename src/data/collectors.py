...
class WeatherBitCollector:
    ...
    def fetch_data_in_chunks(self, start_date, end_date, freq='1Y'):
        ...
        try:
            df = pd.read_csv("weather_data_trabzon.csv")
        except:
            df = pd.DataFrame()
        ...
        while chunk_start < end_date:
            ...
            if df is None:
                ...
                # save as csv
                merged_df.to_csv(f"weather_data_trabzon.csv", index=False)
                df = merged_df
    ...
    def fetch_function(self, start_date, end_date):
        ...
        # Proxy tanımlama
        proxies = {
            "http": "http://hxbfuuzt:8qr3ujm127rb@167.160.180.203:6754",
            "https": "http://hxbfuuzt:8qr3ujm127rb@167.160.180.203:6754"
